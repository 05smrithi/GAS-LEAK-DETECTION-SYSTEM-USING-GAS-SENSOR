...
## Output:
<img width="1919" height="869" alt="image" src="https://github.com/user-attachments/assets/3cc6bd2f-ef64-47f8-9120-31a821b70dd4" />

   

## Result:

Thus the air quality was measured using Gas Sensor  MQ-2 with Arduino UNO Board/ESP-32 using Tinker CAD.
